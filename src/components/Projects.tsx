...
export const Projects = () => {
  ...
  // Use projects directly from portfolio data
                    ...
                    <div className="relative h-full">
                      ...
                      <div className="relative h-72 overflow-hidden">
                        ...
                        <div className="absolute top-4 right-4 z-20">
                          <motion.div
                            className={`flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-xl ${statusColor} bg-black/30 border border-white/20 shadow-lg shadow-black/50`}
                        ...
                        <div className="absolute top-4 left-4 z-20 flex gap-2 opacity-0 group-hover/card:opacity-100 transition-all duration-300">
                          {project.githubUrl && (
                            <motion.a
                              ...
                              whileTap={{ scale: 0.95 }}
                              className="p-3 rounded-xl bg-black/50 hover:bg-purple-600/90 text-white backdrop-blur-xl border border-white/20 shadow-xl shadow-black/30 transition-all"
                      ...
                      <div className="relative p-6 bg-gradient-to-b from-slate-900/95 to-slate-900/98 backdrop-blur-md">
                          ...
                          <div className="flex flex-wrap gap-2 mb-5">
                            {project.technologies.slice(0, 3).map((tech, index) => (
                              <motion.span
                                ...
                                className="px-3 py-1.5 bg-gradient-to-r from-purple-600/20 to-pink-600/20 text-purple-200 rounded-lg text-xs font-medium border border-purple-500/30 backdrop-blur-sm hover:border-purple-400/50 hover:from-purple-600/30 hover:to-pink-600/30 transition-all duration-200"
                              >
                                {tech}
                              </motion.span>
                            ))}
                        ...
                        <div className="flex items-center gap-2 text-purple-400 group-hover/card:text-purple-300 transition-colors pt-4 border-t border-white/5">
                          ...
                          >
                            <ArrowRight size={16} className="group-hover/card:translate-x-2 transition-transform duration-300" />
                          </motion.div>
                        </div>
                      </div>
